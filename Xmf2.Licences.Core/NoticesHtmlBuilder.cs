...
namespace Xmf2.Licences
{
    ...
    {
        private readonly Dictionary<Licence, string> _licenseTextCache = new();
        ...
        public static NoticesHtmlBuilder Create() => new();

        public static NoticesHtmlBuilder Create(string style) => new(style);
